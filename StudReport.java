...
/*<applet code= StudReport height=500 width=500> </applet>*/
public class StudReport extends Applet implements ActionListener
{
    ...
    TextField txtRegNo,txtName,txtJava,txtSE,txtCA,txtBI,txtSSPD;
      ...
      {
            setLayout(null);
            lblTitle=new Label("Enter Student’s Detail");
...
public void paint(Graphics g)
    {
            ...
            g.drawString("Computer Architectur : "+txtCA.getText(),0,400);
            g.drawString("PHP : "+txtBI.getText(),0,425);
            g.drawString("Python : "+txtSSPD.getText(),0,450);
