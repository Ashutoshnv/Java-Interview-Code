...
// A function to print the adjacency matrix. void PrintMat(int mat[][20], int n)
{
int i, j;
...
cout<<"152	Ashutosh Yadav"<<endl;
cout<<"Enter the number of vertexes: "<<endl; cin>>v;
int mat[20][20]; cout<<"\n";
